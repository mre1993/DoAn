...
<div class="col-md-12">
    <form action="{{route('phieuxuat.printExcel',$phieuXuat->MaPhieuXuat)}}" method="get">
 ...
 <div class="form-nhap">
        <table class="table print-phieu-nhap">
            ...
            <tr>
                <td colspan="8"><p>Người nhập: {{$phieuXuat->NhanVien->TenNV}}</p></td>
            </tr>
            <tr>
                <td colspan="8"><p>Lý do nhập: {{$phieuXuat->NoiDung}}</p></td>
            </tr>
            <tr>
