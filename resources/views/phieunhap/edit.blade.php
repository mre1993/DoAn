...
@section('right-content')
    <div class="col-md-10">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('phieunhap.update',$phieuNhap->MaPN) }}">
                    <input name="_method" type="hidden" value="PATCH">
                    @csrf
                    <div class="form-group row">
                        <div class="col-md-3">
                            <label for="TenNV" class="col-form-label">Nhân viên: {{$phieuNhap->NhanVien->TenNV}}</label>
                            <input type="hidden" name="MaNV" value="{{$phieuNhap->MaNV}}">
                        </div>
                        ...
                        <div class="col-md-3">
                            <select style="height: 100%;"  name="MaKVT" class="form-control">
                                ...
                                @foreach($MaKVT as $item)
                                    <option value="{{ $item->MaKVT }}" {{ $phieuNhap->MaKVT == $item->MaKVT ? 'selected' : '' }}> {{ $item->TenKVT }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="MaNCC" class="form-control col-md-10" id="MaNCC" style="height: 34px">
                                ...
                                @foreach($MaNCC as $item)
                                    <option value="{{ $item->MaNCC }}" {{ $phieuNhap->MaNCC == $item->MaNCC ? 'selected' : '' }}> {{ $item->TenNCC }}</option>
                                @endforeach
                            </select>
                            <div class="col-md-1">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <textarea id="NoiDung" name="NoiDung" class="form-control" placeholder>{{$phieuNhap->NoiDung}}</textarea>
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row">
